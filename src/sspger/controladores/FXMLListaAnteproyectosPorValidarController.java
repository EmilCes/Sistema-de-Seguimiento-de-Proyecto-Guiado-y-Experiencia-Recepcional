...
public class FXMLListaAnteproyectosPorValidarController implements Initializable{
    ...
    public void initialize(URL url, ResourceBundle rb) {
        try {
            mostrarAnteproyectosPorValidar();
    ...
    private void mostrarAnteproyectosPorValidar() throws IOException {
        spListaAnteproyectos.setVisible(true);
        vbAnteproyectos.getChildren().clear();
        AnteproyectoRespuesta anteproyectoRespuesta = AnteproyectoDAO.obtenerAnteproyectosPorEstado(Constantes.POR_VALIDAR);
